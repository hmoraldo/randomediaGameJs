...
resObjectDataStruct resObjectsList[]={
	...
	// Resource: srfIntroTmgLogo
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/introtmg.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfIntroTmgLogo2
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/introtmg2.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfIntroRediaLogo
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/splash_def.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuBackground3
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/backinthree.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuScreenshot1
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/sshot1.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuScreenshot2
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/sshot2.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuScreenshot3
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/sshot3.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuScreenshot4
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/sshot4.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfMenuScreenshot5
	{
		...
		new graphicResourceClass(
			...
			"data/demogfx/sshot5.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
	...
	// Resource: srfCursorImage
	{
		...
		new graphicResourceClass(
			"cursorImage",// resname
			"data/demogfx/cursor.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			false,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
...
resObjectDataStruct resObjectsList[]={
	...
	// Resource: srfMenuCreditsPhotos
	{
		...
		new graphicResourceClass(
			...
			"data/graphics/imgcredits.png",// filename, null for empty resource
			true,// automatic video or system memory deciding?
			true,// videomem
			true, NULL,// file or resource, resource type
			false,// bmp or pcx
